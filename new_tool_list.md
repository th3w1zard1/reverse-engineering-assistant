...
**24 tools** that replace the original 90 tools through intelligent parameterization. This design reduces LLM context overhead, improves tool selection reliability, and maintains 100% feature coverage. Each tool uses enums, optional parameters, and defaults to provide flexible, powerful functionality.
...
Open multiple programs in the project.

Args:
    (tool definition to be added)
...
The 24 tools above replace all 90 original tools while maintaining 100% feature coverage:
